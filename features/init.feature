Feature: initialize knightrunner by installing prerequisites and checking credential validity
		...
		Scenario: I run `knightrunner init` with valid AWS credentials stored in environment variables\
				Given I have valid AWS credentials stored in environment variables
				When I write `knightrunner init`
				Then I log that 
